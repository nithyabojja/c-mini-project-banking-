...
float blnced;
float amnts;
cout<<"***Bank System Management Mini Project***"<<endl;
do
{
...
cout<<endl<<"Congratulations your account is Created successfully"<<endl;
cout<<acc;
break;
case 2:
...
{
os<<"Account holder first Name:"<<acc.getFName()<<endl;
os<<"Account holder last Name:"<<acc.getLName()<<endl;
